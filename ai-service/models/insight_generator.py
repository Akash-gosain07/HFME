...
Format as JSON with keys: detected_issue, impact, recommendation, suggested_fix"""
                ...
                if response.status_code == 200:
                    ...
                    try:
                        ...
                        return {
                            ...
                            "suggested_fix": parsed.get("suggested_fix", parsed.get("recommendation", "Review and optimize this step")),
                        }
                    except:
    ...
    def _generate_rule_based(
        ...
        if not issues:
            ...
            suggested_fix = "Audit recent UI or backend changes and watch the next few live sessions."
        else:
            # Sort by severity
            ...
            if issue_type == "high_dropout":
                ...
                suggested_fix = "Trim required inputs, surface success criteria, and add contextual helper copy."
                ...
                suggested_fix = "Add inline validation, clearer error copy, and real examples near the failing field."
                ...
                suggested_fix = "Shorten the instruction set, expose defaults, and add a short helper hint beside the action."
                ...
                suggested_fix = "Expose prerequisites on the current step and add a compact summary of prior selections."
                ...
                suggested_fix = "Reduce the amount of work on this step or split the task into smaller checkpoints."
