        ...
        async with self._lock:
            ...
            for workflow_id, workflow_state in self._workflow_state.items():
                ...
                for step in workflow["steps"]:
                    ...
                    contributions = await asyncio.to_thread(self.anomaly_detector.explain, features)
                    ...
                    prediction = await asyncio.to_thread(self.friction_predictor.predict, features, horizon=5)
    ...
    async def _publish_snapshot(self, snapshot: dict[str, Any]):
        ...
        for subscriber in list(self._subscribers):
            try:
                ...
                # Remove stale slow consumers
                self._subscribers.remove(subscriber)
                self._log("warning", "Dropped slow SSE subscriber queue.")
